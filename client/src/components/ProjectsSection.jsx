    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, rgba(226,54,54,0.15), rgba(33,70,199,0.15))`,
          }}
        >
          <span className="font-heading text-4xl tracking-widest opacity-30" style={{ color: 'var(--text-primary)' }}>
        ...
        {project.featured && (
          <div
            className="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-body font-semibold"
            style={{
              background: 'var(--accent-red)',
              color: '#ffffff',
            }}
      ...
      <div className="p-6">
        <h3
          className="font-heading text-2xl tracking-wider mb-2"
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ scale: 1, y: 0 }}
        exit={{ scale: 0.9, y: 20 }}
        className="relative max-w-2xl w-full glass-card overflow-hidden max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close button */}
        <button
        ...
        >
          ...
          <div
            className="absolute inset-0 flex items-center justify-center"
            style={{
              background: `linear-gradient(135deg, rgba(226,54,54,0.2), rgba(33,70,199,0.2))`,
            }}
          >
            <span className="font-heading text-6xl tracking-widest opacity-20" style={{ color: 'var(--text-primary)' }}>
              {project.title.substring(0, 2).toUpperCase()}
            </span>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          <h3
            className="font-heading text-4xl tracking-wider mb-4"
            style={{ color: 'var(--text-primary)' }}
          >
            {project.title}
          </h3>
          ...
          <div className="mb-6">
            <h4
              className="font-body text-sm font-semibold uppercase tracking-wider mb-3"
          ...
          {categories.map((cat) => (
            <button
              ...
              style={{
                ...
                border: `1px solid ${activeFilter === cat ? 'var(--accent-red)' : 'var(--border-color)'}`,
                boxShadow: activeFilter === cat ? '0 4px 15px var(--accent-red-glow)' : 'none',
              }}
            >
              {cat}
            </button>
